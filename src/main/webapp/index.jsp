...
<section>
    ...
    <div class="search">
        ...
        <div class="search_nav">
            <ul>
                <li class="current" id="search_all" data-placeholder="请输入区域..." data-val="0">全部</li>
            </ul>
        </div>
        <br>
        <form action="/selectHouse" method="post" id="form">
            <span class="triangle"></span>
            <div class="search_main">
                <input type="text" class="search_input" name="search_input" id="search_input" placeholder="请输入区域开始查找..."
                       data-val=""/>
